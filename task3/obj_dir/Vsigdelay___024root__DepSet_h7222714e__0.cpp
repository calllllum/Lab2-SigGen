...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*8:0*/ __Vdly__sigdelay__DOT__w_address;
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__dualram__DOT__ram_array__v0;
    ...
    // Body
    __Vdly__sigdelay__DOT__w_address = vlSelf->sigdelay__DOT__w_address;
    __Vdlyvset__sigdelay__DOT__dualram__DOT__ram_array__v0 = 0U;
    __Vdly__sigdelay__DOT__w_address = ((IData)(vlSelf->rst)
                                         ? 0U : (0x1ffU 
                                                 & ((IData)(1U) 
                                                    + (IData)(vlSelf->sigdelay__DOT__w_address))));
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__dualram__DOT__ram_array
            [(0x1ffU & ((IData)(vlSelf->sigdelay__DOT__w_address) 
                        + (IData)(vlSelf->offset)))];
    }
    if (vlSelf->wr) {
        ...
        __Vdlyvdim0__sigdelay__DOT__dualram__DOT__ram_array__v0 
            = vlSelf->sigdelay__DOT__w_address;
    }
    vlSelf->sigdelay__DOT__w_address = __Vdly__sigdelay__DOT__w_address;
